      ...
      <body>
        <div className='xl:hidden fixed flex px-4 py-1  items-center bottom-16 right-8 z-50 bg-menuvar-500 rounded-xl text-white drop-shadow-2xl'>
            ...
            <div className='flex flex-row justify-center'>
                ...
                {active!="home" && (<div className="top-16 hidden p-2 lg:block fixed flex flex-col w-64 h-full bg-slate-700 border-r-xl border-stone-700 text-center text-3xl text-white left-0">
                ...
                <NavBar active={active} className="lg:hidden"/>
        </div>
      </body>
    </html>
  )
